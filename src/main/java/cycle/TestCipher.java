...
//        cs.add(new CycleStruct(new BigInteger("500000000000000"), new BigInteger("999999999999999"), new BigInteger("500000000010000")));
        cs.add(new CycleStruct(new BigInteger("50000000000000000000000"), new BigInteger("99999999999999999999999"), new BigInteger("50000000000000000010000")));
        ...
        cs.add(new CycleStruct(new BigInteger("5000000000000000000000000"), new BigInteger("9999999999999999999999999"), new BigInteger("5000000000000000000010000")));
        cs.add(new CycleStruct(new BigInteger("50000000000000000000000000"), new BigInteger("99999999999999999999999999"), new BigInteger("50000000000000000000010000")));
        cs.add(new CycleStruct(new BigInteger("500000000000000000000000000"), new BigInteger("999999999999999999999999999"), new BigInteger("500000000000000000000010000")));
        cs.add(new CycleStruct(new BigInteger("5000000000000000000000000000"), new BigInteger("9999999999999999999999999999"), new BigInteger("5000000000000000000000010000")));
        cs.add(new CycleStruct(new BigInteger("50000000000000000000000000000"), new BigInteger("99999999999999999999999999999"), new BigInteger("50000000000000000000000010000")));
        cs.add(new CycleStruct(new BigInteger("500000000000000000000000000000"), new BigInteger("999999999999999999999999999999"), new BigInteger("500000000000000000000000010000")));
        for (CycleStruct c: cs) {
            //PrintWriter writer = new PrintWriter("ff_AES_256_CBC");
            PrintWriter writer = new PrintWriter("eme2_"+counter);
