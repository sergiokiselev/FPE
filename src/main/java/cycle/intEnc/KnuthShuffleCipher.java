...
//	private HashMap<byte[],HashMap<byte[],HashMap<BigInteger,BigInteger>>> plaintextPermutationTable = new HashMap<byte[],HashMap<byte[],HashMap<BigInteger,BigInteger>>>();
//	private HashMap<byte[],HashMap<byte[],HashMap<BigInteger,BigInteger>>> ciphertextPermutationTable = new HashMap<byte[],HashMap<byte[],HashMap<BigInteger,BigInteger>>>();
//
...
//		}
//		else {
//			HashMap<byte[],HashMap<BigInteger,BigInteger>> tweakPlaintext = new HashMap<byte[],HashMap<BigInteger,BigInteger>>();
//			HashMap<byte[],HashMap<BigInteger,BigInteger>> tweakCiphertext = new HashMap<byte[],HashMap<BigInteger,BigInteger>>();
